Asset.init({
	...
	sounds:{
		...
		sfx_shotdown:{src:'assets/sounds/ogg/shotdown.ogg'},
		sfx_alarm:{src:'assets/sounds/ogg/alarm.ogg'},
		
		sfx_prism_pickup:{src:'assets/sounds/ogg/prism_pickup.ogg'},
		sfx_prism_putdown:{src:'assets/sounds/ogg/prism_putdown.ogg'},

		sfx_footstep_1:{src:'assets/sounds/ogg/step_1.ogg'},
		sfx_footstep_2:{src:'assets/sounds/ogg/step_2.ogg'},
		sfx_metal_footstep_1:{src:'assets/sounds/ogg/metal_step_1.ogg'},
		sfx_metal_footstep_2:{src:'assets/sounds/ogg/metal_step_2.ogg'},
		...
		music_bg: {src:'assets/music/ogg_64/a_healthy_dystopia.ogg'},
		music_bg_2: {src:'assets/music/ogg_64/home_sweet_homeland.ogg'}
