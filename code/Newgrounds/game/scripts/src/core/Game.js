(function(exports){
	...
	Game.gotoLevel = function(index){
		...
		// HACK - Medals, and shtuff.
		var medalName = null;
		switch(index){
			case 0: medalName="begin"; break;
			case 3: medalName="surveillance"; break;
			case 5: medalName="slidewalk"; break;
			case 7: medalName="power"; break;
		}
		if(medalName){
			window.parent.unlockMedal(medalName);
		}
