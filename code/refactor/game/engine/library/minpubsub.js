...
(function (context) {
  ...
  MinPubSub.cache = cache; // NICKY - expose the cache just coz
  ...
  MinPubSub.subscribeOnce = function ( /* String */ topic, /* Function */ callback) {
    var handle = MinPubSub.subscribe(topic,function(){
  ...
  if (typeof module === 'object' && module.exports) {
    ...
    context.subscribeOnce = MinPubSub.subscribeOnce;
