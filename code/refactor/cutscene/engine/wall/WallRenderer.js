function WallRenderer(wall){
	...
	self.HEADER_IMAGE = Asset.image["icon/header"];
	...
	self.draw = function(ctx){
		...
		ctx.clearRect(startX-self.wall.MARGIN, 0, self.wall.WIDTH+self.wall.MARGIN*2, Game.canvas.height);
		...
		ctx.drawImage(self.HEADER_IMAGE, startX, 0);
